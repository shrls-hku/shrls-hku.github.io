...
I would like to build an algae bioreactor/cultivator for the HKU biolab with space to grow various species of macroalgae (seaweed) and microalgae (phytoplankton) and control conditions such as lighting and temperature. I want to make these materials, samples and the knowledge about them available to the students for use in e.g. biomaterial making and textile dyeing, but also to convey the idea that energy can be harvested with biomass and how algae can be a really powerful food source. How can an installation basically inpire more exeriments an research on this organism? 
